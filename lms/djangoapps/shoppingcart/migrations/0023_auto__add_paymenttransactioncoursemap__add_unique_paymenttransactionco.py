...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'shoppingcart.coupon': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 5, 0, 0)'}),
        ...
        'shoppingcart.paymentprocessortransaction': {
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shoppingcart.Order']"}),
            'processed_at': ('django.db.models.fields.DateTimeField', [], {}),
        ...
        'shoppingcart.registrationcoderedemption': {
            ...
            'redeemed_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 5, 0, 0)', 'null': 'True'}),
